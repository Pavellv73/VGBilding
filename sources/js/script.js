...
$(function () {
    ...
    $(".block2 .slider-block1 .slick-slider").slick({
        dots:true,
        dotsClass: "dots",
        infinite: false,
        slidesToShow: 1,
    ...
    $(".block2 .slider-block2 .slick-slider").slick({
        dots: true,
        dotsClass: "dots",
        infinite: false,
        slidesToShow: 1,
    ...
    $(".block2 .slider-block3 .slick-slider").slick({
        dots:true,
        dotsClass: "dots",
        infinite: false,
        slidesToShow: 1,
